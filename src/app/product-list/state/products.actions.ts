...
export const resetPage = createAction(
  '[Product List / onDestroy] Reset Page Index'
);

export const searchProducts = createAction(
  '[Search / Backend API] Search Products',
  props<{searchKey: string}>()
);

export const searchProductsSuccess = createAction(
  '[Search / Backend API] Search Products Success',
  props<{ res: ProductsResponse, searchKey: string }>()
);

export const changePageWhenSearchProducts = createAction(
